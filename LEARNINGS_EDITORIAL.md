...
- 2026-08-16 · `PROCESO` · En sesiones PROGRAMADAS el repo devuelve "GitHub access to this repository is not enabled for this session. Use add_repo" y esa herramienta no está disponible. No es falta de token ni de egress: es un permiso de sesión. La salida es escribir vía run de Apify.
