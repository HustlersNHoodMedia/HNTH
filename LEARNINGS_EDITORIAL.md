...
- 2026-08-16 · `PRODUCCIÓN` · 🚨 RENDERIZAR LOCAL, no en Apify. Cada versión por Apify son 3 runs con su arranque = 2-4 minutos; local es instantáneo. Cuatro iteraciones de encuadre por Apify son 20 minutos contra segundos. Apify queda solo como respaldo si el render local no está disponible.
