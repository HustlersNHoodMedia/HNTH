...
- 2026-08-14 · `PRODUCCIÓN` · Medidas exactas sacadas de la referencia (no estimar, están en el manual): chip SWIPE LEFT 223x46 px centrado en x=540, top y=1252, margen inferior 51px — es el 20,6% del ancho. El asset ya existe en qc/SWIPE-ASSET.png, no fabricarlo de nuevo.
- 2026-08-14 · `PRODUCCIÓN` · El degradado arranca en y≈400 y llega a negro sólido entre y=530 y y=800 según cuánta foto tenga la tapa. Es un tramo largo y progresivo. Si se ve "muy arriba", NO moverlo abajo: alargar el tramo.
- 2026-08-14 · `PRODUCCIÓN` · Cada línea del titular se centra INDIVIDUALMENTE. Inclinar el bloque entero deja cada línea corrida respecto de la de arriba, porque es un paralelogramo. Cuerpo ~57px con salto 63-65.
- 2026-08-14 · `PROCESO` · Cuando algo del diseño "se ve mal", medirlo contra la referencia con PIL en vez de ajustar a ojo. Bajar PULLEY-FINAL.png o DEON-COVER.png del repo y comparar números. Corregir a ojo cuesta rondas y no converge.
