...
- 2026-08-17 - `PROCESO` - CORRECCION: lo anotado hoy sobre que las sesiones programadas tienen el repo bloqueado NO esta confirmado. GitHub tuvo una caida real el 17/08 (14:49-17:36 UTC) con 20% de errores en la API y ~50% en descargas de contenido crudo. Los 403 y las lentitudes de ese dia se explican por ahi. El dia anterior una tarea programada escribio y entrego perfecto. Ante un 403 en GitHub: revisar githubstatus.com ANTES de concluir que es un permiso.
