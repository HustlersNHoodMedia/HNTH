...
- 2026-08-17 - `PROCESO` - DOS FALLAS DISTINTAS DE GITHUB, no confundirlas. (1) Mensaje "GitHub access to this repository is not enabled for this session. Use add_repo": lo genera el entorno de Claude, no GitHub. Es una restriccion de sesion real y la salida es escribir via run de Apify. (2) 503, timeouts o lentitud: es GitHub caido. El 17/08 hubo una caida real (14:49-17:36 UTC, 20% de errores en API y ~50% en contenido crudo) y ahi se explican los 403 y las esperas de ese dia. ANTE CUALQUIER FALLA DE GITHUB: leer el mensaje exacto y revisar githubstatus.com antes de concluir. GitHub sigue siendo la ruta principal — gratis y probada.
