...
- 2026-08-14 · `PRODUCCIÓN` · El CDN de Instagram (Meta) rechaza descargas desde Apify: timeout con proxy normal y residencial, y el host cambia en cada scrape. NO reintentar. La salida es buscar la misma pieza en TikTok y revisar versión por versión hasta dar con una a cuadro completo, sin logo ni barras. Tarda menos que insistir.
- 2026-08-14 · `PROCESO` · No buscar "otro actor de Apify para bajar de IG": el buscador solo devuelve los ya conectados y no hay descargador de Instagram disponible. Ese camino no existe.
